...
> 📁 Entradas anteriores em **`improvements_sessions.md`** (100 fechamentos, movidos verbatim — MAN-UX10-UX11-REG, MAN-UX12-REG/F1/REFINE, MAN-O2-F2-B1/B1-DONE, MAN-M10-F2).
...
🔲 **Pendente — diagnose CONCLUÍDA 13/08/2026 (MAN-UX-BID0), fix NÃO implementado de propósito
(a decisão é do owner — ver "Por que parei aqui")** — Prioridade **Média**
