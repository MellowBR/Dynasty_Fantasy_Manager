...
⚠️ **F2 ENTREGUE (07/08/2026, MAN-OFF26-10) — 47 testes + dry-run E2E 38/38; aguarda smoke em
produção ([[PROC1]], runbook `runbook_urna_late_drop.md`)** — MAN-OFF26-10-11-REG → -SPEC →
