...
🔲 **Registrado 17/08/2026 (MAN-AUTH1-REG)** — Prioridade **Média** — categoria **UX/auth** —
**registro apenas; nenhuma direção arbitrada, nenhuma mudança de código, nada verificado contra o
código**
