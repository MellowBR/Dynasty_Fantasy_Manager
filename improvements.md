...
### OFF26-20 — `fa_waiver` fora do `_WAIVER_TYPES` + a coluna PROJ do roster não é o que o rollover fará
🔲 **Pendente** — Prioridade **Alta** — diagnose `MAN-OFF26-20-F1` (04/08/2026, read-only)
