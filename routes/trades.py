...
def _compute_cap_impact(team_a, team_b, players_a, players_b, picks_a, picks_b):
    ...
    """
    # OFF26-16: folha única — inclui IR. O contrato viaja com o jogador, esteja ele em
    # IR ou não, então o delta da troca é o mesmo de sempre.
    cap_a = team_a.total_salary()
    cap_b = team_b.total_salary()
